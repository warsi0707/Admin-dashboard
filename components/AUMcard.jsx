...
export default function AUMcard() {
  return (
    <div className='w-full py-5 border border-slate-300 rounded-md shadow-xl justify-center grid grid-cols-5'>
        <div className='flex flex-col gap-3 justify-center items-center text-center col-span-3 md:col-span-4'>
            <p>Current</p>
            <div className='flex items-center gap-2'>
                 <h1 className='text-2xl font-bold'>AUM 12.19 </h1>
                 <p className='text-xl font-thin text-gray-800'>Cr</p>
            </div>
